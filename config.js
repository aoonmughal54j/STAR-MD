...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '923465125306'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  '✦-𝐉 𝐄 𝐄 𝐑 𝐘-✦',
  packname:  process.env.PACK_NAME || 'MADE BY ✦-𝐉 𝐄 𝐄 𝐑 𝐘-✦ ',
  
  botname:   process.env.BOT_NAME === undefined ? "✦-𝐉 𝐄 𝐄 𝐑 𝐘-✦" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '✦-𝐉 𝐄 𝐄 𝐑 𝐘-✦' : process.env.OWNER_NAME,  
